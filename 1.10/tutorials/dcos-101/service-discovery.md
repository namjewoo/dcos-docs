...
# Named Virtual IPs
  ...
  * [Named VIPs](/docs/1.10/networking/load-balancing-vips/) allow you to assign name/port pairs to your apps, which means you can give your apps meaningful names with a predictable port. They also provide in-built load balancing when using multiple instances of an application. 
